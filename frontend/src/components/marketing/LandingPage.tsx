    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-accent selection:text-black overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
                ...
                >
                    <span className="px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-sm font-medium text-accent backdrop-blur-md mb-6 inline-block">
                    ...
                    <p className="text-lg md:text-2xl text-white/60 max-w-2xl mx-auto mb-10 leading-relaxed">
                        ...
                        <span className="text-white font-semibold">AI & Memory</span> to force you into Flow State.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <p className="text-sm text-white/40 mt-2 sm:mt-0">
                ...
                >
                    <div className="relative rounded-xl border border-white/10 bg-zinc-900/50 backdrop-blur-sm shadow-2xl overflow-hidden aspect-video transform group-hover:rotate-x-2 transition-transform duration-700 ease-out">
                        {/* Mock UI */}
                        <div className="absolute inset-0 flex items-center justify-center text-white/10 font-mono text-4xl font-bold uppercase tracking-widest">
                            Aura OS Dashboard
                        </div>
            ...
            <section className="py-10 border-y border-white/5 bg-white/[0.02]">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-12 text-white/20 font-bold text-xl grayscale opacity-50">
                        {['ACME Corp', 'Stark Industries', 'Wayne Tech', 'Cyberdyne', 'Massive Dynamic'].map(brand => (
                            <span key={brand} className="hover:text-white hover:opacity-100 transition-colors">{brand}</span>
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-20">
                    ...
                    <p className="text-xl text-white/60">Everything you need to reclaim 4+ hours every day.</p>
                </div>
            ...
            <section className="py-24 px-6 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10 border border-white/10 bg-zinc-900/80 p-12 rounded-3xl backdrop-blur-xl">
...
const OfferCard = ({ icon, title, desc, value }: { icon: any, title: string, desc: string, value: string }) => (
    <div className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-accent/40 hover:bg-white/[0.07] transition-all duration-300">
        <div className="mb-6 p-4 bg-black/40 rounded-xl inline-block border border-white/5">
            {icon}
        </div>
        <h3 className="text-2xl font-bold mb-3">{title}</h3>
        <p className="text-white/60 mb-6 leading-relaxed">{desc}</p>
        <div className="text-accent font-mono text-sm uppercase tracking-wider opacity-80 border-t border-white/10 pt-4">
            {value}
        </div>
    </div>
);
