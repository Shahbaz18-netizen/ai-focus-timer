                    ...
                    <div className="p-10 backdrop-blur-2xl bg-black/40 shadow-xl border border-white/10 rounded-[22px]">
                        {!isJournaling ? (
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">Target Time Reached!</h3>
                            ...
                            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-lg font-bold text-white">Daily Journal</h3>
                                </div>
                                <textarea
                                    className="w-full bg-black/50 border border-white/10 rounded-xl p-4 text-white placeholder:text-white/20 focus:outline-none focus:border-accent/50 min-h-[150px]"
