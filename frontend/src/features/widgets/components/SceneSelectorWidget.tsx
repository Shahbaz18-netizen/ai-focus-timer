...
export const SceneSelectorWidget = () => {
    ...
    return (
        <motion.div
            ...
            className="fixed bottom-24 right-8 w-80 bg-[#121212]/95 backdrop-blur-3xl border border-white/20 xl:w-96 rounded-2xl shadow-[0_30px_60px_rgba(0,0,0,0.8)] overflow-hidden z-50 flex flex-col ring-1 ring-white/10"
        >
